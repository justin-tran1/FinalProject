...
ui <- navbarPage(
  ...
  tabPanel(
    ...
    sidebarLayout(
      img(src = "logo.png", width = "250px", height = "250px", align = 'right-center'),
      mainPanel(
...
With this knowledge, An artist can now create music that has a higher change of success and mass popularity; something crucial to the identity of music in popular culture. Valence data is perfect data to refer to
        ...
        h5("Why is my music so popular in the clubs not for individual listening?")
  ...
  tabPanel(
    ...
    sidebarLayout(
      sidebarPanel(
        ...
        p("Valence is defined by Spotify as the musical positiveness conveyed
 ...
 p("All the songs in an album have a valence value
